...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"mock_api.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.mockFetchHelper = mockFetchHelper;

function mockFetchHelper() {
  var isSuccess = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : true;
  var returnValue = arguments.length > 1 ? arguments[1] : undefined;
  var timeoutValue = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 1000;
...
},{}],"albums.json":[function(require,module,exports) {
module.exports = {
  "albums": [{
...
var raw_albums = require('./albums.json');

function readAlbums() {
  return _readAlbums.apply(this, arguments);
}

function _readAlbums() {
  _readAlbums = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var table;
...
function reverseDate(date) {
  ...
  var reverse = split[1] + "/" + split[2] + "/" + split[0];
  return reverse;
}
